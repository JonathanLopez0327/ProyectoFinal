                ...
                <v-card height="580" class="crd-t">
                  ...
                  <v-card-title>
                    ...
                    <v-toolbar dark color="#064a76" width="500" style="border-radius: 4px;">
                      ...
                      <v-toolbar-title class="ml-5">Reportes de Entrada</v-toolbar-title>
                    </v-toolbar>
                  ...
                  <v-data-table dense height="300" :headers="headers" :items="reportes" :search="search" :items-per-page="10" class="mt-6 dtables">
                    <template v-slot:top>
                            ...
                            <v-container>
                              <v-row>
                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.CODE_PRODUCT_ENTRY" label="Codigo del Producto" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.NAME_PRODUCT_ENTRY" label="Nombre del Producto" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.STOCK_ENTRY" label="Unidad del Producto" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.UNITARY_PRICE_ENTRY" label="Cantidad a Agregar" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.UNIT_PRODUCT_ENTRY" label="Fecha Inicial" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.DATE_OF_ENTRY" label="Categoria" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>

                                <v-col cols="12" sm="6" md="4">
                                  <v-text-field v-model="editado.STOCK_CURRENT" label="Precio Unitario" color="#e5520f" clearable prepend-icon="mdi-package-variant"></v-text-field>
                                </v-col>
                             </v-row>
                            </v-container>
                          </v-card-text>
